...
{
    [Serializable]
    public class PlayQ1Page4Data
    {
        public TextSetting nicknamePlayerA;
        public TextSetting nicknamePlayerB;
    }

    public class PlayQ1Page4Controller : PlayQ1PageBase
    {
        [Header("Page 4 UI")]
        ...
        {
            var pageData = data as PlayQ1Page4Data;
        ...
        private void Update()
        {
            ...
            // 입력 테스트용 (실제로는 Manager에서 Trigger로 호출됨)
        ...
        private IEnumerator TransitionCheckImage(Image backImage, Image lightImage)
        {
            ...
            backColor.a = 1f; lightColor.a = 0f;
            backImage.color = backColor; lightImage.color = lightColor;
            ...
            backColor.a = 0f; backImage.color = backColor;
            lightColor.a = 1f; lightImage.color = lightColor;
        }
